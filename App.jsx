...
const TUTORIAL_STEPS = [
  {
    title: <span>ようこそ<R t="音楽" r="おんがく" />スタジオへ！</span>,
    text: <span>ここは<R t="君" r="きみ" />だけの<R t="曲" r="きょく" />を<R t="作" r="つく" />れる<R t="魔法" r="まほう" />のアプリ「キッズ・ビートメーカー」だよ。<br/>たった1<R t="分" r="ぷん" />で<R t="遊" r="あそ" />び<R t="方" r="かた" />を<R t="教" r="おし" />えるね！</span>,
    targetId: null
  },
  {
    title: <span>1. メロディを<R t="作" r="つく" />ろう</span>,
    text: <span><R t="上" r="うえ" />の<R t="段" r="だん" />はメロディ（<R t="旋律" r="せんりつ" />）のトラック。<br/>マスを【クリック】するか【なぞって】<R t="色" r="いろ" />を<R t="塗" r="ぬ" />ると、その<R t="場所" r="ばしょ" />でドレミの<R t="音" r="おと" />が<R t="鳴" r="な" />るよ！</span>,
    targetId: 'tutorial-melody'
  },
  {
    title: <span>2. リズムを<R t="重" r="かさ" />ねよう</span>,
    text: <span><R t="下" r="した" />の<R t="段" r="だん" />はドラムセット！<br/>「ドン・タン・チッ」の<R t="音" r="おと" />を<R t="組" r="く" />み<R t="合" r="あ" />わせて、かっこいいビートを<R t="作" r="つく" />ってみよう。</span>,
    targetId: 'tutorial-drum'
  },
  {
    title: <span>3. <R t="音楽" r="おんがく" />を<R t="再生" r="さいせい" />！</span>,
    text: <span><R t="音" r="おと" />を<R t="置" r="お" />いたら【<R t="再生" r="さいせい" />】ボタンを<R t="押" r="お" />してみて！<br/><R t="時間" r="じかん" />を<R t="示" r="しめ" />す<R t="光" r="ひかり" />が<R t="動" r="うご" />き<R t="出" r="だ" />して、<R t="君" r="きみ" />の<R t="作" r="つく" />った<R t="曲" r="きょく" />が<R t="流" r="なが" />れ<R t="出" r="だ" />すよ。</span>,
    targetId: 'tutorial-play'
  },
  {
    title: <span>4. <R t="魔法" r="まほう" />のサウンド<R t="設定" r="せってい" /></span>,
    text: <span>「<R t="音階" r="おんかい" />」や「<R t="楽器" r="がっき" />」を<R t="変" r="か" />えると、<R t="同" r="おな" />じ<R t="置" r="お" />き<R t="方" r="かた" />でも<R t="曲" r="きょく" />の<R t="雰囲気" r="ふんいき" />がガラッと<R t="変" r="か" />わるよ！<br/>『<R t="反響" r="はんきょう" />（やまびこ）』を<R t="入" r="い" />れるとプロっぽい<R t="音" r="おと" />になるよ。</span>,
    targetId: 'tutorial-settings'
  },
  {
    title: <span>5. <R t="曲" r="きょく" />の<R t="保存" r="ほぞん" />とダウンロード</span>,
    text: <span><R t="作" r="つく" />った<R t="曲" r="きょく" />は<R t="自動" r="じどう" />で<R t="保存" r="ほぞん" />されるから<R t="安心" r="あんしん" />してね。<br/>【MP3<R t="出力" r="しゅつりょく" />】を<R t="押" r="お" />せば、<R t="音声" r="おんせい" />ファイルとしてパソコンにダウンロードもできるよ！</span>,
    targetId: 'tutorial-export'
  },
  {
    title: <span><R t="準備完了" r="じゅんびかんりょう" />！</span>,
    text: <span>これで<R t="使" r="つか" />い<R t="方" r="かた" />はバッチリ！<br/>わからなくなったら、<R t="右" r="みぎ" /><R t="上" r="うえ" />の【？ボタン】を<R t="押" r="お" />してね。<br/>さあ、<R t="君" r="きみ" />だけのオリジナル<R t="曲" r="きょく" />を<R t="作" r="つく" />ろう！</span>,
    targetId: null
  }
];
